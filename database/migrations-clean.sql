-- SocialConnect Database Schema - Clean Installation
-- This script drops everything first, then recreates it cleanly
...
AND tablename IN ('users', 'posts', 'follows', 'likes', 'comments', 'notifications', 'refresh_tokens')
ORDER BY tablename;
